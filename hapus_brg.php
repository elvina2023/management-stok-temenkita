...
if (isset($_POST['delete']))
{
    ...
    $delete_data2 = $stok->delete_barang_stokout($array_data);
    $delete_data3 = $stok->delete_barang_stokT($array_data);
    $delete_data4 = $stok->delete_barang_stokS($array_data);
    $delete_data5 = $stok->delete_barang_stokP($array_data);
    $delete_data6 = $stok->delete_barang_stokin($array_data);
    $delete_data = $stok->delete_barang_frompack($array_data);
...
<body>
    ...
    <div class="container mt-5 mb-5">
        <form method="post">
            ...
            <p>Apakah anda ingin menghapus Data barang berikut ini?</p>

            <?=isset($msg) ? $msg : ''?>

            <b>Nama Barang</b>
            <p><?=$fetch_data->nama_item?></p>
